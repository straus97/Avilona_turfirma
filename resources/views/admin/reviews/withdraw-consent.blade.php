...
<div class="card-custom">
    ...
    <form method="POST" action="{{ route('cabinet.admin.reviews.withdraw-consent', $review) }}">
        @csrf
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('cabinet.admin.reviews.edit', $review) }}" class="btn btn-outline-secondary">Отмена</a>
