...
class ImageController extends Controller
{
    public function __invoke($slug)
    {
        ...
        $meta_description = "Узнайте больше о " . $id_countries_image->title . " и получите незабываемые впечатления с туристической фирмой Авилона. Откройте для себя широкий выбор стран с туристической фирмой Авилона. Узнайте о культуре, традициях, национальных блюдах и достопримечательностях каждой страны. Полезная информация для туристов и памятка путешественника.";
